...
public class OpponentDirectAttackAnimation implements Runnable {
	...
	public void run() {
		...
		if (this.button == duelFrame.getOpponentMonsterZone1().getButton()) {
			this.duelFrame.getImpactExplosionlabel().setBounds((int) 910, (int) 155, (int) 1000, (int) 1130.4);

		} else if (this.button == duelFrame.getOpponentMonsterZone2().getButton()) {
			this.duelFrame.getImpactExplosionlabel().setBounds((int) 796.6, (int) 155, (int) 1000, (int) 1130.4);

		} else if (this.button == duelFrame.getOpponentMonsterZone3().getButton()) {
			this.duelFrame.getImpactExplosionlabel().setBounds((int) 683.2, (int) 155, (int) 1000, (int) 1130.4);
		}
