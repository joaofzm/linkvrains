...
public class OpponentDeck extends Deck {
	...
	public OpponentDeck() {
		...
		trumpet1 = new MonsterCard(this, "9", 1500, 2);
		trumpet2 = new MonsterCard(this, "9", 1500, 2);
		trumpet3 = new MonsterCard(this, "9", 1500, 2);
		guitar1 = new MonsterCard(this, "10", 2500, 4);
		guitar2 = new MonsterCard(this, "10", 2500, 4);
		guitar3 = new MonsterCard(this, "10", 2500, 4);
		guitarAgain1 = new MonsterCard(this, "11", 5000, 8);
		guitarAgain2 = new MonsterCard(this, "11", 5000, 8);
		guitarAgain3 = new MonsterCard(this, "11", 5000, 8);
